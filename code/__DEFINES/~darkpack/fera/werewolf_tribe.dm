...
#define TRIBE_HART_WARDENS "Hart Wardens" //TFN EDIT CHANGE - Hart Wardens - Original: #define TRIBE_FIANNA "Fianna"
#define TRIBE_GALESTALKERS "Galestalkers"
#define TRIBE_GET_OF_FENRIS "Get of Fenris"
#define TRIBE_GHOST_COUNCIL "Ghost Council" //TFN EDIT CHANGE - Ghost Council - Original: #define TRIBE_UKTENA "Uktena"
