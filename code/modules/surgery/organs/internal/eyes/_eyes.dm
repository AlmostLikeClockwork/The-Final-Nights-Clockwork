...
/obj/item/organ/eyes/proc/generate_body_overlay(obj/item/bodypart/head/my_head)
	...
	if(my_head.head_flags & HEAD_EYECOLOR)
		eye_right.color = my_head.owner?.get_right_eye_color() || eye_color_right // TFN EDIT CHANGE - Fixing Protean 1 Eyes - Original:		eye_right.color = eye_color_right || my_head.owner?.get_right_eye_color()
		eye_left.color = my_head.owner?.get_left_eye_color() || eye_color_left // TFN EDIT CHANGE - Fixing Protean 1 Eyes - Original: 		eye_left.color = eye_color_left || my_head.owner?.get_left_eye_color()
